  FUNCTION(CREATE_TARGET TARGET_NAME)
      ...
      IF(DO_NOT)
          ...
          TARGET_INCLUDE_DIRECTORIES(${TARGET_NAME} PUBLIC ${CMAKE_BINARY_DIR}/include/tsl)
      ...
      TARGET_INCLUDE_DIRECTORIES(${TARGET_NAME} PUBLIC ${CMAKE_BINARY_DIR}/include/mqtt-c)
      TARGET_INCLUDE_DIRECTORIES(${TARGET_NAME} PUBLIC ${CMAKE_BINARY_DIR}/include/mqtt-c/src/)
      TARGET_INCLUDE_DIRECTORIES(${TARGET_NAME} PUBLIC ${CMAKE_BINARY_DIR}/include/mqtt-cpp)
      TARGET_LINK_LIBRARIES(${TARGET_NAME} PUBLIC paho-mqtt3a paho-mqttpp3)
      MESSAGE(CHECK_PASS "[${.g}COMPLETE${..}]")
      TARGET_LINK_DIRECTORIES(${TARGET_NAME} PUBLIC ${CMAKE_BINARY_DIR}/include/mqtt-c/src)

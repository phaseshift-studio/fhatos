...
[INFO]  [/sys/router] main memory [total=>5632]
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> */sys/scheduler
thread spawned: inst()[cpp] [stack size:32384]
>[
==>thread=>[
=>]
==>bundle=>[
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> /mmadt/bool[true]
thread spawned: inst()[cpp] [stack size:32384]
==>true
fhatos> bool[true]
==>true
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> /mmadt/real[6.2]
thread spawned: inst()[cpp] [stack size:32384]
==>6.200000
fhatos> real[6.2]
==>6.200000
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> /mmadt/str['cooties']
thread spawned: inst()[cpp] [stack size:32384]
==>'cooties'
fhatos> str['cooties']
==>'cooties'
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> /mmadt/noobj[]
thread spawned: inst()[cpp] [stack size:32384]
fhatos> noobj[]
fhatos> noobj
fhatos> 
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> */mmadt/ext/#/
thread spawned: inst()[cpp] [stack size:32384]
>[
==>/mmadt/ext/C=>C()[is(gte(-273.14999))]
==>/mmadt/ext/Ox=>Ox()[is(true)]
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> band -> |band?int{?}<=int(_,_)[is(and([gte(*<0>),lte(*<1>)]))]
thread spawned: inst()[cpp] [stack size:32384]
==>band?intnoobj<=int(_,_)
	[band[is(and([gte(from(0)),lte(from(1))]))]]
fhatos> 3.band(2,8)                                // <1>
==>3
fhatos> 10.band(2,8)                               // <2>
[ERROR] [/sys/scheduler] noobj [[noobj][_]] not in range of band(2,8)[band[is(and([gte(from(0)),lte(from(1))]))]] [SIGNATURE HERE]
----
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> band -> |band?int{?}<=int(min=>_,max=>_)[is(and([gte(*min),lte(*max)]))]
thread spawned: inst()[cpp] [stack size:32384]
==>band?intnoobj<=int(min=>_,max=>_)
	[band[is(and([gte(from(min)),lte(from(max))]))]]
fhatos> 3.band(2,8)                           // <1>
==>3
...
[ERROR] [/sys/scheduler] [/sys/lang/parser] 2 is not a str as defined by [str][_] 
	  ...
	  thrown at inst 'abc' => band(min=>2,max=>8)[band[is(and([gte(from(min)),lte(from(max))]))]] [min=>2,max=>8]
----
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> band -> |band?int{?}<=int(min=>else(2),max=>else(8))[is(and([gte(*min),lte(*max)]))]
thread spawned: inst()[cpp] [stack size:32384]
==>band?intnoobj<=int(min=>else?noobj<=obj(2)[noobj],max=>else?noobj<=obj(8)[noobj])
	[band[is(and([gte(from(min)),lte(from(max))]))]]
fhatos> 1.band(min=>1)                        // <1>
==>1
fhatos> 10.band()                             // <2>
[ERROR] [/sys/scheduler] noobj [[noobj][_]] not in range of band(min=>2,max=>8)[band[is(and([gte(from(min)),lte(from(max))]))]] [SIGNATURE HERE]
fhatos> {2,3,4,5}.band(min=>3,max=>4)         // <3>
[ERROR] [/sys/scheduler] noobj [[noobj][_]] not in range of band(min=>3,max=>4)[band[is(and([gte(from(min)),lte(from(max))]))]] [SIGNATURE HERE]
----
...
[ERROR] [/sys/scheduler] [/mmadt/noobj] noobj accessed as int
	  thrown at inst 10 => mod(noobj)[cpp] [by?int=>2,0=>noobj]
	  thrown at inst 10 => is_divisble(by?int=>2)[is_divisble[mod(from(by)).eq(0)]] [by?int=>2]
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> is_divisible -> |is_divisble?bool<=int(by?int=>_)[mod(*by).eq(0)]
thread spawned: inst()[cpp] [stack size:32384]
==>is_divisble?bool<=int(by?int=>_)
	[is_divisble[mod(from(by)).eq(0)]]
fhatos> 10.is_divisible(2)
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> band -> |band?int{?}<=int(min=>_,max=>is(gt(*min)).else(*min.plus(1)))[is(gte(*min)).is(lte(*max))]
thread spawned: inst()[cpp] [stack size:32384]
==>band?intnoobj<=int(min=>_,max=>is?noobj<=obj(gt?noobj<=obj(from?noobj<=obj(min)[noobj])[noobj])[noobj].else?noobj<=obj(from?noobj<=obj(min)[noobj].plus?noobj<=obj(1)[noobj])[noobj])
	[band[is(gte(from(min))).is(lte(from(max)))]]
fhatos> 2.band(min=>1,max=>1)                 // <1>
[ERROR] [/sys/scheduler] [/sys/lang/parser] noobj is not a int as defined by [int][_] 
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> is_divisible -> |is_divisble?bool<=int(by?int=>is(neq(0)).else(print('error').map(1)))[mod(*by).eq(0)]
thread spawned: inst()[cpp] [stack size:32384]
==>is_divisble?bool<=int(by?int=>is?noobj<=obj(neq?noobj<=obj(0)[noobj])[noobj].else?noobj<=obj(print?noobj<=obj('error')[noobj].map?noobj<=obj(1)[noobj])[noobj])
	[is_divisble[mod(from(by)).eq(0)]]
fhatos> 10.is_divisible(2)
error[ERROR] [/sys/scheduler] [/mmadt/noobj] noobj accessed as int
	  thrown at inst 10 => mod(noobj)[cpp] [by?int=>2,0=>noobj]
	  thrown at inst 10 => is_divisble(by?int=>2)[is_divisble[mod(from(by)).eq(0)]] [by?int=>2]
fhatos> 10.is_divisible('abc')
----
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> int(a=>2)[*a]
thread spawned: inst()[cpp] [stack size:32384]
==>2
fhatos> 4 + int(a=>2)[*a]
==>6
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> a?sub -> \|to(b)
thread spawned: inst()[cpp] [stack size:32384]
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> thread::create(loop=>||(
          from(|c,0).print('c: {_}').
          plus(1).to(c).
          gt(10).to(t/halt).
          is(_).print('\n'))).to(|t)
...
==>thread/::/create
fhatos> @t.spawn()
[ERROR] [/sys/scheduler] [/mmadt/noobj] spawn inst unresolved 
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> /sys/router/config/resolve/auto_prefix ->
          *(_) + \|[/mmadt/ext/]             // <1>
thread spawned: inst()[cpp] [stack size:32384]
>[
>]
...
[ERROR] [/sys/scheduler] [/mmadt/bcode] is(gt(2)) accessed as uri
----
...
fhatos> {1,2,3}-<[                 
          ...
          is(gt(1)) => mult(0),    
          is(gt(2)) => _]>-
[ERROR] [/sys/scheduler] [/mmadt/bcode] is(gt(0)) accessed as uri
          is(gt(0)) => mult(-1),   
          is(gt(1)) => mult(0),    
          is(gt(2)) => _]>-')[cpp] [code=>'1-<[                 
          is(gt(0)) => mult(-1),   
          is(gt(1)) => mult(0),    
          is(gt(2)) => _]>-']
----
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> 1.plus(1)         // <1>
thread spawned: inst()[cpp] [stack size:32384]
==>2
fhatos> 1. 2              // <2>
==>2
...
==>3.140000
fhatos> noobj.'text {_}'
==>'text console[[delay=>nat[0],loop=>inst()[cpp],config=>[processor=>/sys/vm,nest=>2,ellipsis=>50,prompt=>'
fhatos> noobj.a/b/c
==>a/b/c
fhatos> noobj.[1,2,3]
>[
...
[ERROR] [/sys/router] unable to read from true.i?dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1
	 [/mnt/cache] no query processor for dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1 on read
[ERROR] [/sys/router] unable to read from true.i?dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1
	 [/mnt/cache] no query processor for dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1 on read
[ERROR] [/sys/router] unable to read from true.i?dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1
	 [/mnt/cache] no query processor for dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1 on read
[ERROR] [/sys/scheduler] [/sys/lang/parser] noobj is not a lst as defined by [lst][_] 
		 \_/mmadt/noobj is not a subtype of /mmadt/lst
	  thrown at inst noobj => true.i(noobj)[true.i[and(_,from(0))]] [0=>noobj]
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> a?sub -> |print(_)
thread spawned: inst()[cpp] [stack size:32384]
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> /type/int/nat -> |is(gt(0))
thread spawned: inst()[cpp] [stack size:32384]
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> /io/console/config/nest->3
thread spawned: inst()[cpp] [stack size:32384]
==>3
fhatos> */sys/router/#/
>[
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> a -> 'snowbutt'            // <1>
thread spawned: inst()[cpp] [stack size:32384]
==>'snowbutt'
fhatos> *a                         // <2>
==>'snowbutt'
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> a/a -> 1; a/b -> 2; a/b/c -> 3; a/b/d -> 4;
thread spawned: inst()[cpp] [stack size:32384]
fhatos> *a/b            // <1>
==>2
fhatos> *a/b/           // <2>
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> abc?k1=v1&k2=v2&k3=v3                     // <1>
thread spawned: inst()[cpp] [stack size:32384]
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> 1.plus(2)
thread spawned: inst()[cpp] [stack size:32384]
==>3
----
...
[source,mmadt]
----
[INFO]  [/io/console] fhatos> --- write matrix
thread spawned: inst()[cpp] [stack size:32384]
fhatos> m/0/0 -> 0
==>0
fhatos> m/0/1 -> 1

...
The different embeddings also have different space costs, where space is the amount of data accessed (i.e. pulled from the structure) in order to
resolve the respective fURI.

...
#elif defined(DOCTEXT_PLATFORM_ESP)
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void test_run_end(const TestRunStats& p) override {
            ...
            s << Color::Cyan << "[doctest] " << Color::None
              ...
              << ((p.numTestCasesFailed > 0) ? "FAIL" : "PASS") << Color::None << std::endl;
            s <<  p.numTestCasesPassingFilters << " Tests " << p.numTestCasesFailed << " Failures "
              << p.numTestCases - p.numTestCasesPassingFilters << " Ignored" << std::endl;
        }

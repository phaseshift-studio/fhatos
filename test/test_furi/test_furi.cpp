...
void test_uri_query_prefix() {
  ...
  void test_uri_match() {
    ...
    FOS_TEST_ASSERT_NOT_MATCH_FURI(ID("/fos"), Pattern("/fos/sys/#"));
    FOS_TEST_ASSERT_MATCH_FURI(ID("/fos/sys"), Pattern("/fos/sys/#"));
    FOS_TEST_ASSERT_MATCH_FURI(ID("/fos/sys/router"), Pattern("/fos/sys/#"));
    FOS_TEST_ASSERT_MATCH_FURI(ID("/fos/sys/router/memory"), Pattern("/fos/sys/#"));
    FOS_TEST_ASSERT_MATCH_FURI(ID("/fos/sys/router/memory::main"), Pattern("/fos/sys/#"));
  }

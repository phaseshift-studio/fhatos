...
namespace fhatos {
  ...
  void test_define_as_parsing() {
    FOS_CHECK_RESULTS<Int>({u(FOS_TYPE_PREFIX "int/even")}, FOS_TYPE_PREFIX "int/even -> |mod(2).is(eq(0))");
    ...
    FOS_CHECK_RESULTS<Uri>({u(FOS_TYPE_PREFIX "int/even")}, "__(even[32]).type()"s);

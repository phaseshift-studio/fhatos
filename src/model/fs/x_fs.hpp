...
namespace fhatos {
    ...
    public:
        ...
        virtual void setup() override {
            ...
            Types::singleton()->saveType(id_p(INST_FS_FURI->resolve("root")),
                                         Obj::to_inst(
                                             ...
                                             IType::ZERO_TO_ONE, Obj::to_noobj(), id_p(INST_FS_FURI->resolve("root"))));
            ...
            Types::singleton()->saveType(id_p(INST_FS_FURI->resolve("touch")),
                                         Obj::to_inst(
                                             ...
                                             IType::ONE_TO_ONE, Obj::to_noobj(), id_p(INST_FS_FURI->resolve("touch"))));
        ...
        virtual fURI make_native_path(const ID &path) const {
            const string tempPath = (path.toString().substr(0, this->id()->toString().length()) == this->id()->
                                     toString())

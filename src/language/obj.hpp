...
namespace fhatos {
  ...
  public:
    ...
    //////////////////////////////////////////////////////////////
    [[nodiscard]] OType o_type() const { return OTypes.toEnum(string(this->_id->path(FOS_BASE_TYPE_INDEX))); }
    ...
    [[nodiscard]] bool is_type() const { return !this->_value.has_value(); }

...
namespace mmadt {
  class mmADT : public Rec {
  public:
    static Rec_p singleton() {
      return make_shared<Rec>(mmADT());
    }
  ...
  private:
    ...
    static Uri_p inst_id(const string &opcode) { return vri(INST_FURI->resolve(opcode)); }

...
namespace mmadt {
  ...
  void mmADT::register_module() {
    ...
    REGISTERED_MODULES->insert_or_assign(
        "/mmadt/inst",
        InstBuilder::build(Typer::singleton()->vid->add_component("/mmadt/inst"))
            ->domain_range(OBJ_FURI, {0, 1}, REC_FURI, {1, 1})
            ->inst_f([](const Obj_p &, const InstArgs &) {
              ...
              InstBuilder::build(MMADT_PREFIX "embed")
                  ...
                  ->inst_f([](const Obj_p &obj, const InstArgs &) { return obj->embedding(); })
                  ->save();
              ...
              InstBuilder::build(MMADT_PREFIX "apply")
                  ->domain_range(OBJ_FURI, {0, 1}, OBJ_FURI, {0, 1})
                  ->inst_args(rec({{"rhs", Obj::to_bcode()}, {"args", __().isa(*REC_FURI)}}))
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    Obj_p rhs_temp = args->arg("rhs");
                    Obj_p args_temp = args->arg("args");
                    // if(rhs_temp->is_inst())
                    //  return rhs_temp->apply(lhs, args);
                    ROUTER_PUSH_FRAME("#", args_temp);
                    try {
                      const Obj_p result = lhs->apply(rhs_temp);
                      ROUTER_POP_FRAME();
                      return result;
              ...
              InstBuilder::build(MMADT_PREFIX "as")
                  ...
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    ...
                    return type_uri->is_uri() ? lhs->as(id_p(ROUTER_RESOLVE(type_uri->uri_value())))
                                              : lhs->as(type_uri->tid);
                  })
                  ->save();

              InstBuilder::build(MMADT_PREFIX "bool/" MMADT_INST_SCHEME "/as")
                  ->domain_range(BOOL_FURI, {1, 1}, OBJ_FURI, {0, 1})
                  ->inst_args(lst({mmADT::isa_arg(URI_FURI)}))
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    // uri or obj (for type obj)
                    if(args->arg(0)->is_uri()) {
              ...
              InstBuilder::build(MMADT_PREFIX "int/" MMADT_INST_SCHEME "/as")
                  ->domain_range(INT_FURI, {1, 1}, OBJ_FURI, {0, 1})
                  ->inst_args(lst({mmADT::isa_arg(URI_FURI)}))
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    // uri or obj (for type obj)
                    if(args->arg(0)->is_uri()) {
              ...
              InstBuilder::build(MMADT_PREFIX "real/" MMADT_INST_SCHEME "/as")
                  ->domain_range(REAL_FURI, {1, 1}, OBJ_FURI, {0, 1})
                  ->inst_args(lst({mmADT::isa_arg(URI_FURI)}))
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    // uri or obj (for type obj)
                    if(args->arg(0)->is_uri()) {
              ...
              InstBuilder::build(MMADT_PREFIX "str/" MMADT_INST_SCHEME "/as")
                  ->domain_range(STR_FURI, {1, 1}, OBJ_FURI, {0, 1})
                  ->inst_args(lst({mmADT::isa_arg(URI_FURI)}))
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    // uri or obj (for type obj)
                    if(args->arg(0)->is_uri()) {
              ...
              InstBuilder::build(MMADT_PREFIX "at")
                  ...
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    ...
                    return (new_lhs->is_noobj() || new_lhs->vid) ? new_lhs
                                                                 : new_lhs->at(id_p(args->arg(0)->uri_value()));
                  })
                  ->save();
              ...
              InstBuilder::build(MMADT_PREFIX "rec/" MMADT_INST_SCHEME "/lshift")
                  ->inst_args(lst({mmADT::isa_arg(INT_FURI)}))
              ...
              InstBuilder::build(MMADT_PREFIX "uri/" MMADT_INST_SCHEME "/lshift")
                  ...
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    if(args->arg(0)->is_int() || args->arg(0)->is_noobj()) {
                      return Obj::to_uri(
                          lhs->uri_value().pretract(args->arg(0)->is_int() ? args->arg(0)->int_value() : 1), URI_FURI,
                          lhs->vid);
                    } else {
              ...
              InstBuilder::build(MMADT_PREFIX "uri/" MMADT_INST_SCHEME "/rshift")
                  ...
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    if(args->arg(0)->is_int() || args->arg(0)->is_noobj()) {
                      return Obj::to_uri(
                          lhs->uri_value().retract(args->arg(0)->is_int() ? args->arg(0)->int_value() : 1), URI_FURI,
                          lhs->vid);
                    } else {
              ...
              InstBuilder::build(MMADT_PREFIX "lst/" MMADT_INST_SCHEME "/rshift")
                  ...
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    ...
                    const Lst_p result =
                        Obj::to_lst(make_shared<std::vector<Obj_p>>(internal->begin(), internal->begin() + end + 1),
                                    lhs->tid, lhs->vid);
                    return result;
                  })
                  ->save();
              ...
              InstBuilder::build(MMADT_PREFIX "lst/" MMADT_INST_SCHEME "/lshift")
                  ...
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
                    ...
                    const Lst_p result = Obj::to_lst(
                        make_shared<std::vector<Obj_p>>(internal->begin() + start, internal->begin() + end + 1),
                        lhs->tid, lhs->vid);
                    return result;
                  })
                  ->save();
              ...
              InstBuilder::build(MMADT_PREFIX "each")->inst_args(lst({mmADT::isa_arg(OBJ_FURI)}))->save();

              InstBuilder::build(MMADT_PREFIX "lst/" MMADT_INST_SCHEME "/each")
                  ->inst_args(lst({mmADT::isa_arg(LST_FURI)}))
              ...
              InstBuilder::build(MMADT_PREFIX "rec/" MMADT_INST_SCHEME "/each")
                  ->inst_args(lst({mmADT::isa_arg(REC_FURI)}))
              ...
              InstBuilder::build(MMADT_PREFIX "eq")
                  ...
                  ->inst_args(lst({Obj::to_bcode()}))
                  ->inst_f(
                      [](const Obj_p &lhs, const InstArgs &args) { return Obj::to_bool(lhs->equals(*args->arg(0))); })
                  ->save();
              ...
              InstBuilder::build(MMADT_PREFIX "else")
                  ...
                  ->inst_f(
                      [](const Obj_p &lhs, const InstArgs &args) { return lhs->is_noobj() ? args->arg("other") : lhs; })
                  ->save();
              ...
              InstBuilder::build(MMADT_PREFIX "merge")
                  ...
                  // ->inst_args(lst({Obj::to_rec({{mmADT::isa_arg(INT_FURI), Obj::to_bcode()}, {Obj::to_bcode(),
                  // jnt(INT32_MAX)}})}))
                  ->inst_f([](const Obj_p &lhs, const InstArgs &args) {
              ...
              for(const auto &i: {"gt", "gte", "lt", "lte"}) {
                ...
                for(const auto &t: {INT_FURI, REAL_FURI, STR_FURI, URI_FURI}) {
                  ...
                  if(strcmp(i, "gt") == 0) {
                    builder->inst_f(
                        [](const Obj_p &lhs, const InstArgs &args) { return Obj::to_bool(*lhs > *args->arg(0)); });
              ...
              InstBuilder::build(MMADT_PREFIX "bool/" MMADT_INST_SCHEME "/inspect")
                  ...
                  ->inst_args(lst({Obj::to_bcode()}))
                  ->inst_f([](const Obj_p &, const InstArgs &args) {
                    const Rec_p rec = mmADT::build_inspect_rec(args->arg(0));
                    return rec;
                  })
                  ->save();
              ...
              InstBuilder::build(MMADT_PREFIX "inst/" MMADT_INST_SCHEME "/inspect")
                  ...
                  ->inst_args(lst({Obj::to_bcode()}))
                  ->inst_f([](const Obj_p &, const InstArgs &args) {
                    const Rec_p rec = mmADT::mmADT::build_inspect_rec(args->arg(0));
              ...
              //////////////////////////////// MODULO ////////////////////////////////////
              InstBuilder::build(MMADT_PREFIX "mod")->inst_args(lst({mmADT::isa_arg(INT_FURI)}))->save();
              ...
              InstBuilder::build(MMADT_PREFIX "int/" MMADT_INST_SCHEME "/mod")
                  ...
                  ->save();
              ////////////////////////////// NEGATIVE /////////////////////////////////////
              InstBuilder::build(MMADT_PREFIX "neg")->inst_args(lst({mmADT::isa_arg(OBJ_FURI)}))->save();

              InstBuilder::build(MMADT_PREFIX "bool/" MMADT_INST_SCHEME "/neg")
                  ->inst_args(lst({mmADT::isa_arg(BOOL_FURI)}))
              ...
              InstBuilder::build(MMADT_PREFIX "real/" MMADT_INST_SCHEME "/neg")
                  ->inst_args(lst({mmADT::isa_arg(REAL_FURI)}))
              ...
              Typer::singleton()->end_progress_bar("!bmmadt !yinst!! installed");
              return Obj::to_rec();
            })
            ->create());
  }

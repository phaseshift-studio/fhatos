...
(function () {
    var mmadt_grammar = (function () {
        ...
        */
        ...
        function mmadt(hljs) {
            ...
            const MMADT_URI = {
                className: 'mmadt-uri',
                begin: /\/(mmadt|fos|sys|io|mnt)[a-zA-Z0-9/]+/,
                returnBegin: false,
                relevance: 10
            }
            ...
            const MMADT_REFERENCE = {
                className: 'mmadt-reference',
                begin: /@[_a-zA-Z]+|■|\*[_a-zA-Z]+/,
                returnBegin: false,
                relevance: 10
            }
    ...
    locales["en"] = ["copy","🐷","copied to clipboard"];

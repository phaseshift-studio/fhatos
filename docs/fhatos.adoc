...
[INFO]  [/sys/type] /fos/ui/console type [delay=>[nat][_],loop=>_,halt=>[bool][_],::=>[clear=>clear()[cpp],eval=>eval?obj{?}<=console(code=>noobj)[cpp]]] overwritten
[INFO]  [/sys/type] /fos/ui/console/::/clear type defined
[INFO]  [/sys/type] /fos/ui/console/::/eval type defined

...
[INFO]  [/sys/router] ../../../conf/boot_config.obj boot config file loaded (size: 880 bytes)
[INFO]  [/sys/router] 
  [
    ...
    console=>[terminal=>[stdout=>/io/terminal/:stdout,stdin=>/io/terminal/:stdin],nest=>2,ellipsis=>50,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>32384,stack_trace=>true]
    fs=>[root=>./data/fs]
  ]@/boot/config
...
[ERROR] [/sys/scheduler] [/mmadt/noobj] noobj accessed as str
	  thrown at inst char['a']@a => plus()[cpp] [code=>'@a + @b']
fhatos> *a
==>char['a']@a
fhatos> @a.as(str) + @b
==>'aa'@a
...
==>nat[12]@a
fhatos> @a.minus(11)
[ERROR] [/sys/scheduler] [/sys/lang/parser] 11 is not a int as defined by [int][_] 
		 \_/mmadt/obj is not a subtype of /mmadt/int
fhatos> @a.minus(2)
[ERROR] [/sys/scheduler] [/sys/lang/parser] 2 is not a int as defined by [int][_] 
		 \_/mmadt/obj is not a subtype of /mmadt/int
fhatos> *a
==>nat[12]@a
----
...
A https://en.wikipedia.org/wiki/Named_parameter[named argument] denotes a fURI that references an `obj` in the router's frame structure.
...
==>int8[126]
fhatos> @a + 1
[ERROR] [/sys/scheduler] [/sys/lang/parser] 1 is not a int as defined by [int][_] 
		 \_/mmadt/obj is not a subtype of /mmadt/int
fhatos> @a + 1
[ERROR] [/sys/scheduler] [/sys/lang/parser] 1 is not a int as defined by [int][_] 
		 \_/mmadt/obj is not a subtype of /mmadt/int

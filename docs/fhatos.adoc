...
[INFO]  [/sys/router] ../../../conf/boot_config.obj boot config file loaded (size: 797 bytes)
[INFO]  [/sys/router] 
  [
...
==>/mmadt/jump=>jump?obj{?}<=obj(isa(/mmadt/uri))[cpp]
...
==>char['b']@b
fhatos> @a + @b
[ERROR] [/sys/scheduler] only inst currently supported: _
...
fhatos> @a.minus(11)
[ERROR] [/sys/scheduler] only inst currently supported: _
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'@a.minus(11)')[cpp] [code=>'@a.minus(11)']
fhatos> @a.minus(2)
[ERROR] [/sys/scheduler] only inst currently supported: _
...
fhatos> @a + 1
[ERROR] [/sys/scheduler] only inst currently supported: _
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'@a + 1')[cpp] [code=>'@a + 1']
fhatos> @a + 1
[ERROR] [/sys/scheduler] only inst currently supported: _
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'@a + 1')[cpp] [code=>'@a + 1']
fhatos> @a + 1                               // <3>
...
[ERROR] [/sys/scheduler] only inst currently supported: _
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'34.make_bigger(a=>plus(10))[plus(*a)]')[cpp] [code=>'34.make_bigger(a=>plus(10))[plus(*a)]']
----
...
[ERROR] [/sys/scheduler] only inst currently supported: _
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'2.rec[[is(gt(2)) => plus(2), _ => 0]]')[cpp] [code=>'2.rec[[is(gt(2)) => plus(2), _ => 0]]']
----
...
[ERROR] [/sys/scheduler] only inst currently supported: isa(/mmadt/obj)
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>0,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'{1,2,3}.[is(gt(2)) => _, _ => noobj]          // <2>')[cpp] [code=>'{1,2,3}.[is(gt(2)) => _, _ => noobj]          // <2>']
fhatos> {1,2,3}.[is(gt(2)) => _, _ => noobj]>-        // <3>
[ERROR] [/sys/scheduler] only inst currently supported: isa(/mmadt/obj)
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>0,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'{1,2,3}.[is(gt(2)) => _, _ => noobj]>-        // <3>')[cpp] [code=>'{1,2,3}.[is(gt(2)) => _, _ => noobj]>-        // <3>']
----
...
fhatos> {1,2,3}.[                 
          ...
          _   => mult(100)]>-
[ERROR] [/sys/scheduler] only inst currently supported: _
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'{1,2,3}.[                 
          ?>2 => mult(-1),  
          _   => mult(100)]>-')[cpp] [code=>'{1,2,3}.[                 
          ?>2 => mult(-1),  
          _   => mult(100)]>-']
----
...
fhatos> nat[3].plus(2)
[ERROR] [/sys/scheduler] only inst currently supported: _
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'nat[3].plus(2)')[cpp] [code=>'nat[3].plus(2)']
fhatos> nat[3].mult(-2)
[ERROR] [/sys/scheduler] only inst currently supported: _

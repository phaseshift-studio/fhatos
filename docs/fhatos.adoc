...
[INFO]  [/sys/router] ../../../conf/boot_config.obj boot config file loaded (size: 736 bytes)
...
++++
<!-- 🐓 ./main_runner.out "int[6].inspect()" "real[6.0].inspect()" -->
<!-- 🐖 -->
++++
[source,mmadt]
----
...
++++
<!-- 🐓 ./main_runner.out "/fos/sys/threadx[[halt=>false,delay=>nat[0],loop=>from(|a,0).plus(1).to(a).print(_).[is(gt(10)) => |true.to(abc/halt)]>-]]@abc" "@abc.spawn()" -->
<!-- 🐖 -->
++++
[source,mmadt]
----
fhatos> /fos/sys/threadx[[halt=>false,delay=>nat[0],loop=>from(|a,0).plus(1).to(a).print(_).[is(gt(10)) => |true.to(abc/halt)]>-]]@abc
>threadx[
==>halt=>false
==>delay=>nat[0]
...
++++
<!-- 🐓 ./main_runner.out "person -> |[name=>str[_],age=>nat[_]]" "person[[name=>'fhatty',age=>0]]" "person[[name=>'fhatty',age=>1]]" -->
<!-- 🐖 -->
++++
[source,mmadt]
----
fhatos> person -> |[name=>str[_],age=>nat[_]]
>[
==>name=>_
==>age=>_
>]
...
a|
++++
<!-- 🐓 ./main_runner.out "*a" "*b" "b -> 12" "a -> b" "*a" "**a" -->
<!-- 🐖 -->
++++
[source,mmadt]
----
...
a|
++++
<!-- 🐓 ./main_runner.out "a -> 12" "*a.plus(10)" "*a" "@a" "@a.plus(10)" "*a"  -->
<!-- 🐖 -->
++++
[source,mmadt]
----

...
[INFO]  main [total=>11386880,free=>11385440,used=>0.01265]
[INFO]  [/sys/router/] router started
[INFO]  [/sys/router/] heap <none> spanning /sys/# mounted
[INFO]  [/sys/router/] heap /mnt/mnt spanning /mnt/# mounted
[INFO]  [/sys/router/] heap /mnt/boot spanning /boot/# mounted
[INFO]  [/mmadt/rec] boot working directory: /home/killswitch/software/fhatos/build/docs/build
...
[WARN]  [/sys/router/] no mounted structure for fs  
[WARN]  [/sys/router/] no mounted structure for log  
[WARN]  [/sys/router/] no mounted structure for /io/log  
...
[WARN]  [/sys/router/] no mounted structure for button  
[WARN]  [/sys/router/] no mounted structure for /io/z  
[INFO]  [/sys/router/] /boot/config boot config file loaded [size: 894 bytes]
...
[INFO]  [/boot/config] 
   [
     ...
     main=>main()[start({heap[[pattern=>+/#]]@/mnt/var}).end().start({fs[[pattern=>/fs/#,config=>[root=>/fs]]]@/mnt/fs}).end().mount(at(/mnt/var)).end().mount(at(/mnt/fs)).end().start({log[[=>]]@/io/log}).end().start({terminal[[=>]]@/io/terminal}).end().start({console[[=>]]@/io/console}).end().start({/io/console/config/stack_size}).ref(259072).end().start({button[[pin=>gpio[5],on_push=>lift(print('button pushed'))]]@/io/z}).end().spawn(at(/io/console)).end().bundle(at(/io/z)).end()]
   ]@/boot/config
      .oO configuring kernel objs Oo.
[INFO]  [/sys/mem] main [total=>11927552,free=>11925824,used=>0.01449]
[INFO]  [/sys/router/] router configured
            [id=>/sys/router,config=>[namespace=>[:=>/mmadt/,fos:=>/fos/],auto_prefix=>[,/mmadt/,/mmadt/ext/,/fos/,/fos/sys/,/fos/s/,/fos/io/,/fos/sensor/,/fos/ui/,/fos/util/,/sys/]]]
[INFO]  [/boot/config] router boot config dropped
[INFO]  [/sys/scheduler] scheduler started
[INFO]  [/sys/scheduler] scheduler configured
            [id=>/sys/scheduler,config=>[def_stack_size=>32384]]
...
[INFO]  [/sys/typer] /sys/typer/module/fos/qproc type defined
[INFO]  [/sys/typer] /sys/typer/module/fos/io/gpio type defined
...
[INFO]  [/sys/typer] typer configured
            [id=>/sys/typer,config=>[module=>[/mmadt/#,/fos/#]]]
[INFO]  [/boot/config] typer boot config dropped
      .oO mounting fos/mmadt structures Oo.
[INFO]  [/sys/mem] main [total=>12468224,free=>12466336,used=>0.01514]
[INFO]  [/sys/router/] heap /mnt/io spanning /io/# mounted
      .oO importing fos/mmadt types Oo.
[INFO]  [/sys/mem] main [total=>12468224,free=>12466336,used=>0.01514]
[WARN]  [/sys/typer] /sys/typer/module/fos/qproc type qproc?rec<=obj{?}()[cpp] overwritten
[WARN]  [/sys/typer] /sys/typer/module/fos/io/gpio type gpio?rec<=obj{?}()[cpp] overwritten
[INFO]  [/sys/typer] /sys/typer/module/mmadt/base type defined
[INFO]  [/sys/typer] /sys/typer/module/mmadt/ext type defined
[INFO]  [/sys/typer] /mmadt/proc type defined
[INFO]  [/sys/typer] /mmadt/proc/::/eval type defined
[INFO]  [/sys/router/] /io/parser obj loaded
      .oO evaluating main inst Oo.
[INFO]  [/sys/mem] main [total=>12603392,free=>12601440,used=>0.01549]
[INFO]  [/boot/config] exiting boot state: stricter type checking enabled
[INFO]  [/boot/config] applying main inst
            main()[start({heap[[pattern=>+/#]]@/mnt/var}).end().start({fs[[pattern=>/fs/#,config=>[root=>/fs]]]@/mnt/fs}).end().mount(at(/mnt/var)).end().mount(at(/mnt/fs)).end().start({log[[=>]]@/io/log}).end().start({terminal[[=>]]@/io/terminal}).end().start({console[[=>]]@/io/console}).end().start({/io/console/config/stack_size}).ref(259072).end().start({button[[pin=>gpio[5],on_push=>lift(print('button pushed'))]]@/io/z}).end().spawn(at(/io/console)).end().bundle(at(/io/z)).end()]
[INFO]  [/sys/router/] heap /mnt/var spanning +/# mounted
[INFO]  [/mnt/fs] data/fs location mounted
[INFO]  [/sys/router/] fs /mnt/fs spanning /fs/# mounted
[INFO]  [/sys/scheduler] /io/console thread spawned
[INFO]  [/sys/scheduler] /io/z fiber bundled
[INFO]  [/sys/mem] main [total=>88375296,free=>88373216,used=>0.00235]
...
[ERROR] [/mnt/io] unable to read /io/console/config/nest
[ERROR] [/mnt/io] unable to read /io/console/config/terminal/stdout
...
fhatos> --- char['b']@b
fhatos> @a + @b
[ERROR] [/sys/router/] no mounted structure for a  
...
fhatos> @a.as(str) + @b
[ERROR] [/sys/router/] no mounted structure for a  
[ERROR] [/mmadt/parser] noobj is not a /mmadt/str as defined by [str][_] 
...
fhatos> nat[12]@a
[ERROR] [/sys/router/] no mounted structure for a/is  
[ERROR] [/sys/router/] no mounted structure for a/::/mmadt/is  
[ERROR] [/sys/router/] no mounted structure for a/::/mmadt/is  
[ERROR] [/sys/router/] no mounted structure for a/gte  
[ERROR] [/sys/router/] no mounted structure for a/::/mmadt/gte  
[ERROR] [/sys/router/] no mounted structure for a/::/mmadt/gte  
[ERROR] [/sys/router/] no mounted structure for a  
[ERROR] [/sys/router/] no mounted structure for a/config/stack_size  
==>nat[12]@a
fhatos> @a.minus(11)
[ERROR] [/sys/router/] no mounted structure for a  
[ERROR] [ /mmadt/obj ]  /mmadt/minus inst unresolved 
	         lhs id      inst id         resolve obj         
	  ->[/mmadt/obj] /mmadt/minus => minus(_)
fhatos> @a.minus(2)
[ERROR] [/sys/router/] no mounted structure for a  
[ERROR] [ /mmadt/obj ]  /mmadt/minus inst unresolved 
	         lhs id      inst id         resolve obj         
...
[ERROR] [/sys/router/] no mounted structure for band/::/mmadt/block?dom=/mmadt/int&dc=1,1&rng=/mmadt/int&rc=0,1  
[ERROR] [/sys/router/] no mounted structure for band/::/mmadt/block?dom=/mmadt/int&dc=1,1&rng=/mmadt/int&rc=0,1  
[ERROR] [/sys/router/] no mounted structure for band  
==>band?int{?}<=int(_,_)
...
[ERROR] [/sys/router/] no mounted structure for band  
[ERROR] [/sys/router/] no mounted structure for band  
[ERROR] [ /mmadt/int ]  band inst unresolved 
	         lhs id  inst id    resolve obj
...
[ERROR] [/sys/router/] no mounted structure for band  
[ERROR] [/sys/router/] no mounted structure for band  
[ERROR] [ /mmadt/str ]  band inst unresolved 
	         lhs id  inst id    resolve obj
----
...
[ERROR] [/sys/router/] no mounted structure for min  
...
[ERROR] [/sys/router/] no mounted structure for is_divisble/::/mmadt/block?dom=/mmadt/int&dc=1,1&rng=/mmadt/bool&rc=1,1  
[ERROR] [/sys/router/] no mounted structure for is_divisble/::/mmadt/block?dom=/mmadt/int&dc=1,1&rng=/mmadt/bool&rc=1,1  
[ERROR] [/sys/router/] no mounted structure for is_divisible  
...
[ERROR] [/sys/router/] no mounted structure for is_divisible  
[ERROR] [/sys/router/] no mounted structure for is_divisible  
[ERROR] [ /mmadt/int ]  is_divisible inst unresolved 
	         lhs id  inst id    resolve obj
...
----
fhatos> *y
[ERROR] [/sys/router/] no mounted structure for y  
fhatos> *z
[ERROR] [/sys/router/] no mounted structure for z  
fhatos> z -> 12
[ERROR] [/sys/router/] no mounted structure for z  
==>12
fhatos> y -> z
...
fhatos> **y
[ERROR] [/sys/router/] no mounted structure for y  
[ERROR] [/mmadt/noobj] noobj accessed as uri
	  thrown at inst noobj => from?obj{?}<=obj{?}(noobj,noobj)[cpp] [0=>noobj,1=>noobj]
----
...
----
fhatos> a?sub -> |to(b)
[ERROR] [/sys/router/] no mounted structure for a?sub  
==>to?noobj<=obj(b)[noobj]
fhatos> *a?sub
[ERROR] [/sys/router/] no mounted structure for a?sub  
fhatos> *b
[ERROR] [/sys/router/] no mounted structure for b  
fhatos> a->12
[ERROR] [/sys/router/] no mounted structure for a  
==>12
fhatos> *a
...
fhatos> thread[[loop=>^(
          ...
          gt(10).to(t/halt).
          is(_).print('\n'))]]@t
[ERROR] [/sys/router/] no mounted structure for t  
[ERROR] [/sys/router/] no mounted structure for t/config/stack_size  
>thread[
==>loop=>lift(from(block(c),0).print('c: {_}').plus(1).to(c).gt(10).to(t/halt).is(_).print('\n'))
==>halt=>true
>]@t
fhatos> /sys/scheduler::spawn(@t)
[ERROR] [/sys/router/] no mounted structure for t  
----
...
[ERROR] [/sys/router/] no mounted structure for make_bigger  
[ERROR] [/sys/router/] no mounted structure for make_bigger  
[ERROR] [/sys/router/] no mounted structure for make_bigger  
==>88
----
...
[ERROR] [/sys/router/] no mounted structure for true.i?dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1  
[ERROR] [/sys/router/] no mounted structure for true.i?dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1  
[ERROR] [/sys/router/] no mounted structure for true.i?dom=/mmadt/bool&dc=1,1&rng=/mmadt/bool&rc=1,1  
...
[ERROR] [/sys/router/] no mounted structure for person  
>[
==>name?str=>_
==>age?nat=>is(lt(120))
>]
...
[ERROR] [/sys/router/] no mounted structure for person  
[ERROR] [/sys/router/] no mounted structure for person  
[ERROR] [/mmadt/parser] person is an undefined type
...
[ERROR] [/sys/router/] no mounted structure for age  
==>is?noobj<=obj(gt?noobj<=obj(0)[noobj])[noobj].is?noobj<=obj(lt?noobj<=obj(120)[noobj])[noobj]
fhatos> a -> age[45]
[ERROR] [/sys/router/] no mounted structure for age  
[ERROR] [/mmadt/parser] age is an undefined type
fhatos> *a.inspect()
[ERROR] [/sys/router/] no mounted structure for a  
...
fhatos> */sys/router/#/
>[
==>/sys/router/::/mount=>mount?obj<=obj{?}(structure=>_)[cpp]
==>/sys/router/config=>[
===>namespace=>[
====>:=>/mmadt/
====>fos:=>/fos/
...
==>]
=>]
==>/sys/router/frame=>[rec][_]
==>/sys/router/structure=>[
===>/sys/#
===>/mnt/#
===>/boot/#
===>/fos/#
...
[source,mmadt]
----
[ERROR] [/sys/router/] no mounted structure for u  
fhatos> from(u)
[ERROR] [/sys/router/] no mounted structure for u  
fhatos> *u
[ERROR] [/sys/router/] no mounted structure for u  
...
[ERROR] [/sys/router/] no mounted structure for a/a  
[ERROR] [/sys/router/] no mounted structure for a/b  
[ERROR] [/sys/router/] no mounted structure for a/b/c  
[ERROR] [/sys/router/] no mounted structure for a/b/d  
[ERROR] [/sys/router/] no mounted structure for a/b  
[ERROR] [/sys/router/] no mounted structure for a/b/c  
[ERROR] [/sys/router/] no mounted structure for a/b/d  
fhatos> *a/b            // <1>
...
[ERROR] [/sys/router/] no mounted structure for abc?k1=v1,v2&k2=v3&k3=v4,v5,v6  
==>12
fhatos> *abc
[ERROR] [/sys/router/] no mounted structure for abc  
...
fhatos> --- write matrix
fhatos> m/0/0 -> 0
[ERROR] [/sys/router/] no mounted structure for m/0/0  
==>0
fhatos> m/0/1 -> 1
[ERROR] [/sys/router/] no mounted structure for m/0/1  
==>1
fhatos> m/0/2 -> 2
[ERROR] [/sys/router/] no mounted structure for m/0/2  
==>2
fhatos> m/0/3 -> 3
[ERROR] [/sys/router/] no mounted structure for m/0/3  
==>3
fhatos> m/1/0 -> 4
[ERROR] [/sys/router/] no mounted structure for m/1/0  
==>4
fhatos> m/1/1 -> 5
[ERROR] [/sys/router/] no mounted structure for m/1/1  
==>5
fhatos> m/1/2 -> 6
[ERROR] [/sys/router/] no mounted structure for m/1/2  
==>6
fhatos> m/1/3 -> 7
[ERROR] [/sys/router/] no mounted structure for m/1/3  
==>7
fhatos> m/2/0 -> 8
[ERROR] [/sys/router/] no mounted structure for m/2/0  
==>8
fhatos> m/2/1 -> 9
[ERROR] [/sys/router/] no mounted structure for m/2/1  
==>9
fhatos> m/2/2 -> 10
[ERROR] [/sys/router/] no mounted structure for m/2/2  
==>10
fhatos> m/2/3 -> 11
[ERROR] [/sys/router/] no mounted structure for m/2/3  
==>11
fhatos> --- read matrix
fhatos> *m/0/0      // <1>
[ERROR] [/sys/router/] no mounted structure for m/0/0  
fhatos> *m/0/+      // <2>
[ERROR] [/sys/router/] no mounted structure for m/0/+  
fhatos> *m/+/0      // <3>
[ERROR] [/sys/router/] no mounted structure for m/+/0  
----

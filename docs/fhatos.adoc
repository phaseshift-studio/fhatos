...
[ERROR] [/sys/scheduler] [/mmadt/obj] /mmadt/gt?dom=/mmadt/obj&dc=1,1&rng=/mmadt/bool&rc=1,1 inst unresolved 
	         lhs id      inst id      resolve obj     
	  ->[/mmadt/obj] /mmadt/gt => gt()
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true,nest=>0]]]@/io/console => eval?obj{?}<=console(code=>'{1,2,3}.[is(gt(2)) => _, _ => noobj]          // <2>')[cpp] [code=>'{1,2,3}.[is(gt(2)) => _, _ => noobj]          // <2>']
fhatos> {1,2,3}.[is(gt(2)) => _, _ => noobj]>-        // <3>
[ERROR] [/sys/scheduler] [/mmadt/obj] /mmadt/gt?dom=/mmadt/obj&dc=1,1&rng=/mmadt/bool&rc=1,1 inst unresolved 
	         lhs id      inst id      resolve obj     
	  ->[/mmadt/obj] /mmadt/gt => gt()
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true,nest=>0]]]@/io/console => eval?obj{?}<=console(code=>'{1,2,3}.[is(gt(2)) => _, _ => noobj]>-        // <3>')[cpp] [code=>'{1,2,3}.[is(gt(2)) => _, _ => noobj]>-        // <3>']
----
...
[ERROR] [/sys/scheduler] [/mmadt/int] 0 accessed as uri
	  ...
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'age -> \|(is(gt(0)).is(lt(120)))')[cpp] [code=>'age -> \|(is(gt(0)).is(lt(120)))']
fhatos> a -> age[45]
[ERROR] [/sys/scheduler] [/sys/lang/parser] age is an undefined type
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'a -> age[45]')[cpp] [code=>'a -> age[45]']
fhatos> *a.inspect()
...
[ERROR] [/sys/scheduler] [/mmadt/int] 0 accessed as uri
	  ...
	  thrown at inst console[[halt=>false,delay=>nat[0],loop=>inst()[cpp],config=>[nest=>2,prompt=>'fhatos> ',strict=>false,log=>INFO,stack_size=>24288,stack_trace=>true]]]@/io/console => eval?obj{?}<=console(code=>'/type/int/nat -> |is(gt(0))')[cpp] [code=>'/type/int/nat -> |is(gt(0))']
fhatos> nat[6]
==>nat[6]
fhatos> nat[-6]
